...
<!--	    var ext_version = '--><?php //echo $extversion; ?><!--';-->
    ...
    <div id="maincontainer" class="row">
        ...
        <div id="divider"> </div>
        <div class="row">
            <div class="col-xs-12 center"id="resultarea" ><?php if(!empty($result_content)) {echo $result_content;}  ?></div>
        </div>
                ...
                <form action="form" method="post" accept-charset="utf-8">
                    <div class="form-group customizeParameter row">
                        ...
                        <div class="col-md-6 col-xs-12 ">
                            <input type="text" name="username" id="username" placeholder="username" required="true" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group customizeParameter row">
                        <label for="yourtext" class="col-md-6 col-xs-12">Password</label>
                        <div class="col-md-6 col-xs-12 ">
                            <input type="password" name="pass" id="pass" placeholder="password" required="true"  autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group customizeParameter row">
                        <label for="yourtext" class="col-md-6 col-xs-12">Repository url</label>
                        <div class="col-md-6 col-xs-12 ">
                            <input type="url" name="repourl" id="repourl" value="" placeholder="https://github.com/:username/:repository" required="true"  autocomplete="off" class="form-control" title="(https://github.com/:username/:repository or https://bitbucket.org/:username/:repository" />
                        </div>
                        <div class="col-xs-12">
                    ...
                    <div class="form-group customizeParameter row">
                        ...
                        <div class="col-md-6 col-xs-12 ">
                            <input type="text" name="title" id="title" placeholder="Issue Title" required="true" autocomplete="off" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group customizeParameter row">
                        <label for="yourtext" class="col-md-6 col-xs-12">Issue Description</label>
                        <div class="col-md-6 col-xs-12 ">
                            <textarea name="desc" id="desc" placeholder="Issue Description" required="true" autocomplete="off" class="form-control" ></textarea>
                        </div>
                    </div>
                    <div class="form-group customizeParameter row">
